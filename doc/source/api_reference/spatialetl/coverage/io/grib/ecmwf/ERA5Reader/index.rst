spatialetl.coverage.io.grib.ecmwf.ERA5Reader
============================================

.. py:module:: spatialetl.coverage.io.grib.ecmwf.ERA5Reader
...
.. autoapisummary::
   ...
   spatialetl.coverage.io.grib.ecmwf.ERA5Reader.ERA5Reader


Module Contents
---------------

.. py:class:: ERA5Reader(myFile, academic_flux=False, surface_downward_sensible_heat_flux=0, surface_downward_latent_heat_flux=0, surface_downward_solar_radiation=0, surface_downward_thermal_radiation=0, surface_solar_radiation=0, surface_thermal_radiation=0)

   Bases: :py:obj:`spatialetl.coverage.io.CoverageReader.CoverageReader`


   .. py:attribute:: academic_flux
      :value: False
   ...
   .. py:method:: read_variable_2D_land_binary_mask_at_time(index_t, xmin, xmax, ymin, ymax)
