spatialetl.coverage.io.netcdf.DefaultWriter
===========================================

.. py:module:: spatialetl.coverage.io.netcdf.DefaultWriter
...
.. autoapisummary::
   ...
   spatialetl.coverage.io.netcdf.DefaultWriter.DefaultWriter


Module Contents
---------------

.. py:class:: DefaultWriter(cov, myFile, mode='w')
   ...
   .. py:method:: write_variable_mesh_size_factor()
   ...
   .. py:method:: write_variable_barotropic_sea_water_speed()


   .. py:method:: write_variable_barotropic_sea_water_to_direction()


   .. py:method:: write_variable_barotropic_sea_water_from_direction()
   ...
   .. py:method:: write_variable_sea_water_column_thickness()
   ...
   .. py:method:: write_variable_sea_water_temperature()


   .. py:method:: write_variable_sea_water_salinity()


   .. py:method:: write_variable_baroclinic_sea_water_velocity()
