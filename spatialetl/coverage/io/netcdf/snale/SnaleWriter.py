    ...
    def write_variable_sea_water_column_thickness(self):
        ...
        if (isinstance(self.coverage, TimeCoverage) or isinstance(self.coverage, TimeLevelCoverage)):
            ...
            for time in self.coverage.read_axis_t():
                ...
                data = self.coverage.read_variable_sea_water_column_thickness_at_time(time)

                data[data <= 0.1] = 9.96921e+36
                data[(data > 1.0)& (data != 9.96921e+36 )] = 4
                data[(data > 0.1)&(data <= 0.3)] = 1
                data[(data > 0.3) & (data <= 0.6)] = 2
                data[(data > 0.6) & (data <= 1.0)] = 3
