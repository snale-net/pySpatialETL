    ...
    def read_variable_barotropic_sea_water_velocity_at_time(self, index_t, xmin, xmax, ymin, ymax):
        try:
            ...
            if "wetmask_t" in self.ncfile.variables:
                u_rot[self.ncfile.variables["wetmask_t"][0, ymin_overlap:ymax_overlap, xmin_overlap:xmax_overlap] == 0] = np.nan
                v_rot[self.ncfile.variables["wetmask_t"][0, ymin_overlap:ymax_overlap, xmin_overlap:xmax_overlap] == 0] = np.nan
